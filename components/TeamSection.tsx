...
const TeamSection = () => {
  ...
  <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
    <div>
      <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&amp;fit=crop&amp;q=80&amp;w=1160" alt="" className="aspect-video rounded-lg object-cover"/>
