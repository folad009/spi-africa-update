...
const TeamSection = () => {
  ...
  <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
    <div>
      <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&amp;fit=crop&amp;q=80&amp;w=1160" alt="Eric Johnson" className="aspect-video rounded-lg object-cover"/>
      ...
      <div className="mt-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <a href="#" target="_blank" rel="noreferrer" aria-label="LinkedIn profile for Eric Johnson" className="text-[#0072b1] transition-opacity hover:opacity-90">
    ...
    <div>
      ...
      <div className="mt-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <a href="#" target="_blank" rel="noreferrer" className="text-[#0072b1] transition-opacity hover:opacity-90">
            <svg viewBox="0 0 20 20" fill="currentColor" className="size-7">
