    ...
    <section ref={ref} className="py-24">
      <div className="max-w-5xl mx-auto px-4">
        <div className="bg-spi-primary rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <Link
            to="/community"
            className="inline-block bg-white text-spi-primary px-10 py-5 rounded-full text-xl font-bold hover:bg-slate-50 transition-all shadow-lg active:scale-95 relative z-10"
          >
            Get Started Now
          </Link>
        </div>
