      ...
      <div className="container">
        <div className="flex w-full flex-col overflow-hidden bg-white md:rounded-xl lg:flex-row lg:items-center">
          ...
          <div className="w-full shrink-0 px-4 py-6 md:p-8 lg:w-1/2 lg:px-16">
            ...
            <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#30447F] text-white hover:bg-[#5D9AD2] h-10 px-4 py-2">
              Learn More
            </button>
          </div>
        </div>
