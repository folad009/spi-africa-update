            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-6 p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <a href="tel:08112151795" className="text-slate-600 hover:text-spi-primary transition-colors block">08112151795</a>
                  <a href="tel:09038863747" className="text-slate-600 hover:text-spi-primary transition-colors block">09038863747</a>
                </div>
              </div>
